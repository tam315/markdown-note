...
- コンストラクション＝プログラミング
  ...
  - 「コーディング」という言葉は単なる機械的な作業を連想させるのであまり適切ではない
- コンストラクション以外の作業は？
  - プロジェクトマネジメント
  - 要求開発
  - 概要設計（ソフトウェアアーキテクチャ）
...
- コードが唯一のドキュメントになることがしばしばあるため
- どれだけ急いでいても飛ばせない工程であるため
...
知識を常に収集してストックしておく「知的道具箱」というメタファもよい。
...
- 品質向上したいタイミングが
  ...
  - プロジェクトの最初の場合
    - 高品質な計画、要求、設計を行う
    - 安い車として設計したものは、どれだけ後段で努力してもロールスロイスにはならない
...
- 例えで訴える
  - 海が汚れてたらクジラも汚染されて病気で死ぬ、みたいな食物連鎖の例とか
- データで訴える
  - 問題の修正時期があとになるほど、コストは指数的に増える
