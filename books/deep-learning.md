...
平均$\mu$、分散$\sigma^2$の母集団があるとき、母集団から$n$個の標本を**繰り返し**取り出したとき、その標本平均（データの総計/データの個数）の分布は、平均$\mu$、分散$\sigma^2 / n$の正規分布に近づく。

これは、母集団の分布の様態にかかわらない。

中心極限定理を活用すると、母集団の様態はわからなくても、データをたくさん集めることで、「母集団の平均は＊＊くらいだと思います。誤差は、あっても＊＊くらいです。」と主張できるようになる。

https://www.youtube.com/watch?v=CHOLN1tAJWI
